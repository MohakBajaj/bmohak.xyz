                ...
                <div className="mt-6 flex flex-wrap items-start">
                  {photos.map((photo, index) => (
                    <LifelinePhotoCard
                      ...
                      width={160}
                      className={cn("relative", index > 0 && "mt-6 -ml-8")}
                    />
                  ))}
                </div>
              )}
...
export function LifelineVertical({
  ...
  return (
    <article
      ...
      aria-label={title}
      className={cn(
        "relative px-6 pt-4 pb-10 select-none [&_a]:cursor-pointer",
    ...
    >
      ...
      <div className="relative">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute top-0 bottom-0 -translate-x-1/2 overflow-hidden"
